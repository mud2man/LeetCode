 ...
 * 4. We can prove by we can always get a smaller number by deleting the first decending digit, rather than others. So we know the first peak digit must be deleted
 */
