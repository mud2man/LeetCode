...
public class Solution{
    ...
    public List<List<String>> groupStrings(String[] strings) {
        ...
        for(String s: strings){
            ...
            if(!shiftSequencesGroupMap.containsKey(identity)){
                shiftSequencesGroupMap.put(identity, new ArrayList<String>());
            }
    ...
    public static void main(String[] args){
        ...
        List<List<String>> shiftedStrings;

        System.out.println("strings: " + strings);

        shiftedStrings = sol.groupStrings(strings);

        System.out.println("shifted strings: ");
        for(List<String> strList: shiftedStrings){
